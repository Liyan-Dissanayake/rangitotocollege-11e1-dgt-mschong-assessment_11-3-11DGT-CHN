...
def play(user_choice):
    ...
    # Prevent playing if game is already finished
    if game_over:
        return
...
def reset_game():
    ...
    play_again_btn.pack_forget()  # hide play again button
...
play_again_btn = tk.Button(root, text="Play Again", width=10, command=reset_game)
